...
class EmailLogin(BaseClass):
    ...
    email_header = "//div[@class='mail_details']//div[@class='mail_details_header']"
    forward_icon = "(//span[@class='imoon icon-forward'])[2]"
    input_email_address = "//input[@placeholder='Enter email address']"
    send_icon = "//span[@class='imoon icon-send']"
    reply_icon = "(//span[@class='imoon icon-reply'])[2]"
    reply_all_icon = "(//span[@class='imoon icon-reply-all'])[2]"
    ...
    def email_login(self, log):
        ...
        try:
            self.driver.find_element(By.ID, self.login_username).send_keys(LoginData.email_login_data)
            time.sleep(2)
            self.driver.find_element(By.ID, self.login_password).send_keys(LoginData.email_login_data)
            time.sleep(2)
    ...
    def mail_sender(self, log):
        ...
        sender_email = "staging_radius@visnet.in"
    ...
    def accept_op(self, log):
        ...
        try:
            ...
            time.sleep(1)
            # self.driver.find_element(By.XPATH, self.child_dispostion).click()
            # time.sleep(2)
        ...
        try:
            ...
            time.sleep(7)
            log.info("End email ignore")
        except Exception as e:
            log.error("End email ignore")
            print(f"email ignore{e}")
